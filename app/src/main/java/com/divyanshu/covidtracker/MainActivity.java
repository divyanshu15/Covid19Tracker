package com.divyanshu.covidtracker;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    com.divyanshu.covidtracker.Adapter adapter;
            ...
            public void onResponse(Call<List<ModelClass>> call, Response<List<ModelClass>> response) {
                ...
                for (int i=0;i<modelClassList.size();i++)
                {
                    if(modelClassList.get(i).getCountry().equals(country)){
                        ...
                        int total,recovered,deaths,active;
    ...
    private void updateGraph(int total, int active, int recovered, int deaths) {
        ...
        mpiechart.addPieSlice(new PieModel("Cases",total,Color.parseColor("#FFB701")));
        mpiechart.addPieSlice(new PieModel("Active",active,Color.parseColor("#2e8b57")));
